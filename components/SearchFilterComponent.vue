      ...
      <div class="flex flex-col md:flex-row items-end gap-4">
        ...
        <div class="flex-1">
          <label class="block text-sm font-medium text-gray-80 mb-3"
            >Lokacije</label
          >
          <div class="relative w-full max-w-[255px]">
            <select
        ...
        <div class="mt-4">
          <button
            class="md:col-span-auto bg-primary-80 text-white h-12 py-3 px-4 rounded-lg hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2"
          >
